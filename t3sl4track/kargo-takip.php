<?php
/**
 * Plugin Name: T3SL4Track
 * Description: Müşterilerinize Kargo Takip Bağlantısı Göndermenin En Etkili Yolu.
 * Version: 28.03.2021
 * Author: SYN_T3SL4
 * Author URI: https://github.com/hidirektor
 */
...
if ($tracking_company == 'ptt') {
    ...
    <?php
		...
		if ($tracking_company == 'aramex') {
            echo '<a href="https://www.aramex.com/tr/tr/track/track/results?mode=0&ShipmentNumber=' . $tracking_code . '" target="_blank" rel="noopener noreferrer">';
        }
        if ($tracking_company == 'aras') {
...
function kargoTR_add_kargo_button_in_order($actions, $order)
{
    ...
    if (!empty($tracking_code)) {
		...
		if ($tracking_company == 'aramex') {
            $cargoTrackingUrl = 'https://www.aramex.com/tr/tr/track/track/results?mode=0&ShipmentNumber=' . $tracking_code;
